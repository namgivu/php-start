<?php
/* challenge ref. https://www.hackerrank.com/challenges/bon-appetit */
...
//$PHP_STDIN = 'php://stdin';
$f = fopen($PHP_STDIN, 'r');
$s = fgets($f); sscanf($s, '%d %d', $n, $k);
$s = fgets($f); $a = array_map('intval', explode(' ',$s));
$s = fgets($f); $bCharged = (int)$s;
fclose($f);
...
$result = $bActual==$bCharged ? 'Bon Appetit' : $bCharged-$bActual;
echo $result;